...
export const RecordModal: React.FC<RecordModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/80 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4">
      <div className="bg-[#14141A] rounded-2xl max-w-xl w-full shadow-2xl border border-[#242430] overflow-hidden animate-in fade-in zoom-in-95 duration-150 flex flex-col max-h-[92vh]">
        {/* Header */}
        ...
        {/* Tab Selector (horizontally scrollable on small mobile screens) */}
        {!isEditing && (
          <div className="p-2.5 bg-[#181820] border-b border-[#242430] shrink-0 flex space-x-1.5 overflow-x-auto no-scrollbar">
            <button
              type="button"
              onClick={() => setRecordType('volunteer')}
              className={`flex-1 min-w-[100px] py-2 px-3 rounded-xl text-xs sm:text-sm font-semibold flex items-center justify-center space-x-2 transition-all cursor-pointer whitespace-nowrap ${
